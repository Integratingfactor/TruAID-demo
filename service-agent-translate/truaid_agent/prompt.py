...
- to register agent card use the agent card from memory and use the tool generate_agent_context to create context with agent card and then submit to the blockchain using the 'MCPToolset' tool.
